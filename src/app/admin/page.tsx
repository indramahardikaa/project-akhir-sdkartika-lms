      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div className="flex items-center">
              <div className="p-3 bg-indigo-100 rounded-lg">
                <svg className="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" /></svg>
              </div>
              <div className="ml-4">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button onClick={() => router.push('/admin/users')} className="p-4 bg-indigo-50 hover:bg-indigo-100 rounded-lg text-left transition-colors">
              <h3 className="font-medium text-indigo-900">Kelola Pengguna</h3>
              <p className="text-sm text-indigo-600 mt-1">Tambah, edit, hapus pengguna</p>
            </button>
            <button onClick={() => router.push('/admin/courses')} className="p-4 bg-purple-50 hover:bg-purple-100 rounded-lg text-left transition-colors">
              <h3 className="font-medium text-purple-900">Kelola Kursus</h3>
              <p className="text-sm text-purple-600 mt-1">Atur kursus dan kategori</p>
            </button>
